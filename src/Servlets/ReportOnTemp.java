...
/**
 * Servlet implementation class ReportOnTemp
 */
@WebServlet("/ReportOnTemp")
public class ReportOnTemp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select distinct* from student s,temprature t";       
